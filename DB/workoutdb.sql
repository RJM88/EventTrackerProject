...
START TRANSACTION;
USE `workoutdb`;
INSERT INTO `workout` (`id`, `name`, `description`, `location`, `enabled`, `day`, `img`, `weight`, `date`) VALUES (1, 'Dumbbell chest press', 'Was feeling a little light.', '3 hours', 1, 'Monday', 'https://images.squarespace-cdn.com/content/v1/55e406fbe4b0b03c5e7543ae/1492943899613-FMQR88UGXP5NKKBU39S8/ke17ZwdGBToddI8pDm48kHlZ51lbe8ilPcxU1J_shrlZw-zPPgdn4jUwVcJE1ZvWEtT5uBSRWt4vQZAgTJucoTqqXjS3CfNDSuuf31e0tVEAbiLQYc2gKaU69H6HlPiIR-jdXWp95pzbeNHzaEXGueWQ2NE_qdOrf1Dw30SAtXQ/Decline+Dumbbell+Chest+Press?format=1000w', 'Set 1/10 reps - 60lb, Set 2/10 reps - 60lb, Set 3/10 reps - 65lb', '11/09/2020');
INSERT INTO `workout` (`id`, `name`, `description`, `location`, `enabled`, `day`, `img`, `weight`, `date`) VALUES (2, 'Dips', 'Was a good burn', '3 hours', 1, 'Monday', 'https://thumbs.dreamstime.com/b/exercising-dips-bodybuilding-target-muscles-marked-red-initial-final-steps-43688912.jpg', 'Set 1 / Reps 10, Set 2 / Reps 10, Set 3 / Reps 10', '11/09/2020');
INSERT INTO `workout` (`id`, `name`, `description`, `location`, `enabled`, `day`, `img`, `weight`, `date`) VALUES (3, 'Run', 'The weather was cold and windy. Planned to run 3 miles made it only 2', 'Sloans Lake', 1, 'Monday', 'https://www.interactive-biology.com/wp-content/uploads/2012/04/MuscleManRunning-1024x813.jpg', '2 miles- 10 Min mile', '11/09/2020');
...
INSERT INTO `workout` (`id`, `name`, `description`, `location`, `enabled`, `day`, `img`, `weight`, `date`) VALUES (11, 'SLEEP', 'Slept all day', 'Home', 1, 'Sunday', NULL, 'N/A', '11/15/2020');
